describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [1, 7, 9];
    let bigNumbers: Array<number> = [77, 107, 77];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["hello", false, 1 ]; // set values here - the array will take any type or combo of types.
